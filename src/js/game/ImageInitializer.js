//Loads all images when game starts to avoid creating new image elements when creating a new instance of an item, all items of the class use the same image.
export class ImageInitializer {
    constructor() {
        ...
        let imageClass = document.getElementById("images");
